...
| 6–7 | Unused | Reserved empty layers |
...
```text
keyboards/maple_computing/minidox/rev1/keymaps/adrianpk/keymap.json
```
...
```text
maple_computing/minidox/rev1:adrianpk
```
...
qmk compile -kb maple_computing/minidox/rev1 -km adrianpk
```
